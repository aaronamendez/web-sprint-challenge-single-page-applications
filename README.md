...
The useRouteMatch hook is used for constructing needed paths and providing access to the match object.

1. How would you explain form validation to someone who has never programmed before?

Form validation is the process in which you are validating that whatever the user is inputting into
your form is expected data.

1. In 1-2 sentences, define end to end testing.

Testing is the process of testing a specific function or many specific functions within a unit of your application. You can test the functionality and performance of the application and create an ideal environment to test the data being expected as you desire for the applications needs.
